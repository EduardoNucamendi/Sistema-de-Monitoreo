...
if ($con) {
    // Obtener el último dato recabado para cada sensor DHT22
    ...
    // Obtener el último dato de la balanza HX711
    $consulta_hx711 = "SELECT * FROM Tb_HX711 ORDER BY fecha_actual DESC LIMIT 1";
    $resultado_hx711 = mysqli_query($con, $consulta_hx711);
    $ultimo_dato_hx711 = mysqli_fetch_assoc($resultado_hx711);
    ...
    // Obtener todos los datos de la balanza HX711
    $consulta_todos_hx711 = "SELECT * FROM Tb_HX711 ORDER BY fecha_actual DESC";
    $resultado_todos_hx711 = mysqli_query($con, $consulta_todos_hx711);
} else {
...
<body>
    <div class="container">
        ...
        <!-- Sensor HX711 -->
        <div class="card">
            <h2>Balanza (Sensor HX711)</h2>
            <p><strong>Peso:</strong> <?php echo isset($ultimo_dato_hx711['Peso']) ? $ultimo_dato_hx711['Peso'] . " kg" : "Sin datos"; ?></p>
        </div>
        ...
        <div class="table-container">
           ...
           <!-- Tabla de todos los datos del sensor HX711 -->
     <!-- Tabla para el Sensor HX711 -->
<h3>Sensor HX711</h3>
<div class="table-container">
    <table>
        <thead>
        ...
        <tbody>
            <?php while ($fila_hx711 = mysqli_fetch_assoc($resultado_todos_hx711)): ?>
                <tr>
                    <td><?php echo $fila_hx711['Peso']; ?> kg</td>
                    <td><?php echo $fila_hx711['fecha_actual']; ?></td>
                </tr>
            <?php endwhile; ?>
        </tbody>
    </table>
